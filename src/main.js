...
const i18nDict = {
  ru: {
    ...
    about_app_subtitle: "(Голосовой ввод)",
    about_version: "v1.0.0",
    about_description: "Aura — инструмент глобального голосового ввода для Windows. Программа мгновенно переводит речь в текст и вставляет его в любое активное окно с автоматическим форматированием и расстановкой пунктуации.",
    status_ready: "Готово",
  ...
  en: {
    ...
    about_app_subtitle: "(Voice Input)",
    about_version: "v1.0.0",
    about_description: "Aura is a global voice input tool for Windows. It instantly transcribes speech to text and inserts it into any active window with automatic formatting and punctuation.",
    status_ready: "Ready",
  ...
  es: {
    ...
    about_app_subtitle: "(Entrada de voz)",
    about_version: "v1.0.0",
    about_description: "Aura es una herramienta de entrada de voz global para Windows. Transcribe instantáneamente el habla en texto y lo inserta en cualquier ventana activa con formato y puntuación automáticos.",
    status_ready: "Listo",
  ...
  fr: {
    ...
    about_app_subtitle: "(Saisie vocale)",
    about_version: "v1.0.0",
    about_description: "Aura est un outil de saisie vocale globale pour Windows. Il transcrit instantanément la parole en texte et l'insère dans n'importe quelle fenêtre active avec un formatage et une ponctuation automatiques.",
    status_ready: "Prêt",
  ...
  it: {
    ...
    about_app_subtitle: "(Inserimento vocale)",
    about_version: "v1.0.0",
    about_description: "Aura è uno strumento di inserimento vocale globale per Windows. Trascrive istantaneamente la voce in testo e la inserisce in qualsiasi finestra attiva con formattazione e punteggiatura automatiche.",
    status_ready: "Pronto",
  ...
  zh: {
    ...
    about_app_subtitle: "(语音输入)",
    about_version: "v1.0.0",
    about_description: "Aura 是适用于 Windows 的全局语音输入工具。它可以立即将语音转录为文本，并以自动格式和标点符号插入到任何活动窗口中。",
    status_ready: "就绪",
    btn_save: "保存设置",
    confirm_title: "确认",
  ...
  pt: {
    ...
    about_app_subtitle: "(Entrada de voz)",
    about_version: "v1.0.0",
    about_description: "Aura é uma ferramenta de entrada de voz global para Windows. Transcreve instantaneamente a fala em texto e a insere em qualquer janela ativa com formatação e pontuação automáticas.",
    status_ready: "Pronto",
  ...
  tr: {
    ...
    about_app_subtitle: "(Sesli Giriş)",
    about_version: "v1.0.0",
    about_description: "Aura, Windows için genel bir sesli giriş aracıdır. Konuşmayı anında metne dönüştürür ve otomatik biçimlendirme ve noktalama işaretleriyle herhangi bir aktif pencereye ekler.",
    status_ready: "Hazır",
